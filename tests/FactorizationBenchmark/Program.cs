...
{
    EllipticCurveQ CreateLargeCurve() => new EllipticCurveQ(1, 0, 0,
    ...
    {
        var largeCurve = CreateLargeCurve(); // A fresh instance excludes the arithmetic cache.
...
EllipticCurveQ Curve() => new EllipticCurveQ(0, 1, 0,
